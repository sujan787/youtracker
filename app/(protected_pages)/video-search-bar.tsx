...
import { SetGlobalState, useGlobalState } from "../../components/hooks/use-global-state"
...
interface VideoSearchBarProps extends
    React.HtmlHTMLAttributes<HTMLDivElement> {
    data: VideoSearchInput,
    setData: SetGlobalState<VideoSearchInput>,
    storedValue: VideoSearchInput | null,
    setValue: React.Dispatch<React.SetStateAction<VideoSearchInput | null>>
}

const VideoSearchBar = React.forwardRef<HTMLDivElement, VideoSearchBarProps>(
    ({ data, setData, storedValue, setValue, className, title, children, ...props }, ref) => {
